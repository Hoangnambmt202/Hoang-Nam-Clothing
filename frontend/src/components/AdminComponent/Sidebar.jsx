...
const Sidebar = () => {
    ...
    const menuItems = [
        { icon: <Package />,Link: '/admin/products', label: 'Sản phẩm', count: '245' },
        {icon: <ChartBarStacked/>, Link: '/admin/categories', label: "Danh mục", count: "5"},
        { icon: <Users />, Link: '/admin/users',label: 'Khách hàng', count: '1,200' },
        { icon: <ShoppingBag />, Link: '/admin/orders',label: 'Đơn hàng', count: '54' },
  ...
  return (
    ...
    <div className="p-4">
      <div className="flex items-center justify-between">
        {isSidebarOpen && <h2 className="text-xl font-bold"> <Link to="/admin"> Hoang Nam</Link></h2>}
